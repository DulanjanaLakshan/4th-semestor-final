...
__all__ = [
    ...
    'SPGRAMMARSTATE', 'DISPID_SASNonBlockingIO', 'DISPID_SRStatus',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SLWType',
    'SPWT_PRONUNCIATION', 'DISPID_SPEDisplayAttributes',
    'DISPID_SGRSRule', 'SECFIgnoreWidth', 'SpeechAudioFormatType',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SRRTStreamTime',
    'SP_VISEME_15', 'DISPID_SAEventHandle', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SWFEBitsPerSample', 'DISPID_SDKSetStringValue',
    'DISPID_SVSLastResult', 'DISPID_SpeechPhraseElements',
    'DISPID_SPEAudioTimeOffset', 'ISpeechLexiconWord',
    'SpeechRetainedAudioOptions', 'SDKLDefaultLocation',
    'DISPID_SAVolume', 'SPFM_OPEN_READONLY', 'SVSFVoiceMask',
    'SPRST_INACTIVE', 'SPEI_SR_RETAINEDAUDIO', 'SGRSTTEpsilon',
    'DISPID_SGRSTType', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SpeechObjectTokens', 'DISPID_SGRSAddRuleTransition',
    'SPAUDIOOPTIONS', 'DISPID_SDKDeleteValue',
    'DISPID_SGRSAddSpecialTransition', 'SRTAutopause',
    'SSFMOpenReadWrite', 'DISPID_SRRSpeakAudio',
    'DISPID_SRCVoicePurgeEvent', 'SAFT24kHz16BitMono', 'SP_VISEME_12',
    'DISPID_SLGenerationId', 'DISPID_SVSyncronousSpeakTimeout',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPINTERFERENCE_TOOSLOW',
    'SPINTERFERENCE', 'DISPID_SRRecognizer', 'SpeechTokenKeyFiles',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SAFT44kHz16BitMono',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SpeechLexiconPronunciation',
    'SPWF_SRENGINE', 'DISPID_SRCPause', 'SGSDisabled',
    'DISPID_SRAudioInput', 'SPEI_RECOGNITION', 'DISPID_SOTsItem',
    'SpeechRegistryLocalMachineRoot', 'SRAImport', 'IStream',
    'DISPID_SPRsCount', 'SGRSTTTextBuffer', 'SpeechVoicePriority',
    'ISpeechCustomStream', 'DISPID_SRRGetXMLErrorInfo', 'SPCT_SLEEP',
    'eLEXTYPE_RESERVED4', 'SVP_7', 'ISpPhoneticAlphabetSelection',
    'SLODynamic', 'DISPID_SGRSTPropertyName',
    'DISPID_SRGetRecognizers', 'DISPID_SRRTTickCount',
    'SPLEXICONTYPE', 'SGDSActiveWithAutoPause', 'SAFT44kHz8BitMono',
    'SAFT12kHz16BitMono', 'ISpeechPhraseRules',
    'DISPID_SPRuleChildren', 'Speech_Max_Word_Length',
    'DISPID_SGRSTText', 'DISPID_SRCEInterference', 'SP_VISEME_6',
    'DISPID_SVSpeakStream', 'ISequentialStream', 'SPAUDIOSTATUS',
    'DISPID_SDKSetBinaryValue', 'SpeechCategoryRecoProfiles',
    'SAFT48kHz16BitStereo', 'DISPID_SGRSTsItem', 'SPWORD',
    'DISPID_SpeechPhraseBuilder', 'SRSInactiveWithPurge',
    'DISPID_SPPs_NewEnum', 'SAFT48kHz8BitStereo', 'SVSFNLPSpeakPunc',
    'DISPID_SPEsCount', 'DISPID_SFSClose', 'SPCT_COMMAND',
    'DISPID_SpeechAudio', 'SpeechTokenKeyUI', 'SAFT11kHz8BitStereo',
    'SpeechTokenKeyAttributes', 'DISPID_SpeechGrammarRule',
    'DISPID_SAFGuid', 'ISpeechLexicon', 'SPEI_WORD_BOUNDARY',
    'eLEXTYPE_PRIVATE17', 'SP_VISEME_0', 'SP_VISEME_9',
    'SpUnCompressedLexicon', 'SPVPRI_OVER', 'ISpeechMMSysAudio',
    'DISPID_SPEAudioSizeTime', 'SpPhraseInfoBuilder',
    'eLEXTYPE_PRIVATE13', 'eLEXTYPE_PRIVATE20',
    'DISPID_SPAPhraseInfo', 'SPSUnknown', 'SAFTADPCM_44kHzMono',
    'DISPID_SMSAMMHandle', 'SPPS_NotOverriden',
    'DISPID_SGRsCommitAndSave', 'DISPID_SVEBookmark',
    'SDTReplacement', 'SPWORDTYPE', 'SSTTTextBuffer', 'SDTProperty',
    'SpeechDictationTopicSpelling', 'SPEI_TTS_PRIVATE',
    'SRERequestUI', 'DISPID_SpeechRecoResult2', 'DISPID_SBSFormat',
    'ISpObjectTokenCategory', 'SDA_One_Trailing_Space',
    'SPEI_SOUND_START', 'ISpeechPhoneConverter',
    'SAFTADPCM_44kHzStereo', 'Speech_Default_Weight',
    'ISpRecognizer3', 'DISPID_SRGetPropertyNumber', 'DISPID_SPPsItem',
    'DISPID_SVGetProfiles', 'eLEXTYPE_PRIVATE8', 'SPEI_RESERVED2',
    'STCAll', 'SpeechVoiceEvents', 'DISPID_SPAsCount', 'SDTRule',
    'DISPID_SRCEBookmark', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRIsUISupported', 'DISPID_SGRSTNextState',
    'DISPID_SPRuleParent', 'SDTPronunciation', 'SAFT24kHz8BitMono',
    'ISpPhrase', 'DISPID_SVSInputWordPosition', 'SpeechDiscardType',
    'SAFT8kHz16BitMono', 'SREFalseRecognition', 'DISPID_SASetState',
    'SGPronounciation', 'SAFT11kHz16BitStereo', 'ISpeechAudioFormat',
    'SDTDisplayText', 'DISPID_SGRsItem', 'SDTAudio', 'SPCS_ENABLED',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SVVolume',
    'SDA_Two_Trailing_Spaces', 'SpMMAudioIn', 'DISPID_SMSADeviceId',
    'DISPID_SPRuleName', 'SAFTCCITT_uLaw_22kHzStereo',
    'SpeechCategoryAudioOut', 'DISPID_SMSSetData',
    'ISpeechPhraseProperties', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SRCSetAdaptationData', 'ISpEventSource', 'SpAudioFormat',
    'SpeechTokenIdUserLexicon', 'SAFT16kHz16BitMono',
    'SAFT32kHz8BitMono', 'SpShortcut', 'SPEI_START_SR_STREAM',
    'SVP_15', 'DISPID_SRCERequestUI', 'ISpeechRecoContext',
    'DISPID_SPIAudioStreamPosition', 'SVP_3', 'SPEI_MAX_SR', 'SVP_14',
    'DISPID_SRCBookmark', 'SPVISEMES', 'SAFT22kHz16BitMono',
    'ISpeechResourceLoader', 'DISPID_SRCEAdaptation',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPRuleConfidence',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRCCmdMaxAlternates', 'SVP_10',
    'SP_VISEME_3', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SDKEnumValues', 'DISPID_SPEActualConfidence', 'SVP_5',
    'DISPID_SPEsItem', 'SPRULESTATE', 'SPAR_Medium',
    'SpSharedRecognizer', 'DISPID_SASCurrentSeekPosition',
    'SAFTCCITT_uLaw_44kHzMono', 'SPPS_RESERVED4',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SRGetPropertyString', 'DISPID_SGRSTPropertyValue',
    'SpeechRuleState', 'SpeechPropertyNormalConfidenceThreshold',
    'SPAS_RUN', 'SVSFDefault', 'SPVPRIORITY', 'STSF_CommonAppData',
    'SGDSActive', 'SPDKL_CurrentUser', 'SPSModifier',
    'DISPID_SGRSTransitions', 'SAFT48kHz8BitMono',
    '__MIDL_IWinTypes_0009', 'DISPID_SRRAlternates',
    'DISPID_SRCERecognizerStateChange', 'SECNormalConfidence',
    'DISPID_SpeechXMLRecoResult', 'SVSFlagsAsync',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRCEStartStream',
    'SpeechAudioFormatGUIDText', 'SpeechPartOfSpeech',
    'DISPID_SRSetPropertyString', 'SPRS_ACTIVE',
    'SpeechVoiceSpeakFlags', 'DISPID_SRRRecoContext',
    'DISPID_SVAudioOutputStream', 'SpObjectTokenCategory',
    'SpeechDataKeyLocation', 'SpeechAudioProperties',
    'ISpResourceManager', 'SFTInput', 'DISPID_SVRate',
    'SpStreamFormatConverter', 'SpeechCategoryRecognizers',
    'SAFTCCITT_ALaw_22kHzStereo', 'SRARoot', 'SVSFIsNotXML',
    'Speech_Max_Pron_Length', 'DISPID_SVSLastBookmarkId',
    'SpMemoryStream', 'ISpeechGrammarRule',
    'ISpeechPhraseReplacements', 'DISPID_SDKGetlongValue',
    'SPBOOKMARKOPTIONS', 'SAFTCCITT_uLaw_44kHzStereo', 'SITooLoud',
    'DISPID_SpeechPhraseReplacement', 'SPEI_SR_BOOKMARK', 'SPBO_NONE',
    'SpeechRunState', 'ISpRecoCategory',
    'SpeechPropertyResponseSpeed', 'SREAudioLevel',
    'SPINTERFERENCE_TOOFAST', 'SVP_18', 'SECFIgnoreCase',
    'DISPID_SVSInputWordLength', 'SWPUnknownWordUnpronounceable',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpPhraseAlt',
    'DISPID_SLPsCount', 'DISPID_SVSInputSentencePosition',
    'eLEXTYPE_PRIVATE19', 'DISPID_SPPEngineConfidence', 'SWTDeleted',
    'ISpeechRecoResultDispatch', 'SpNullPhoneConverter',
    'SpeechRegistryUserRoot', 'SWPUnknownWordPronounceable',
    'DISPID_SRRGetXMLResult', 'SPGS_EXCLUSIVE',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPEI_ADAPTATION',
    'SpeechDisplayAttributes', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRGetFormat', 'SPSHT_Unknown', 'SDTAlternates',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SPRNumberOfElements',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPRST_ACTIVE_ALWAYS', 'SAFT22kHz8BitMono',
    'DISPID_SPAStartElementInResult', 'DISPID_SASState',
    'SSSPTRelativeToStart', 'SECFIgnoreKanaType', 'SPEI_HYPOTHESIS',
    'SpeechVisemeType', 'SSFMCreateForWrite', 'DISPID_SWFEChannels',
    'eLEXTYPE_LETTERTOSOUND', 'eLEXTYPE_PRIVATE11',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SP_VISEME_1',
    'DISPID_SVDisplayUI',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SWTAdded',
    'DISPID_SPARecoResult', 'SPEI_START_INPUT_STREAM', 'SRTReSent',
    'SVSFNLPMask', 'SPEI_SOUND_END', 'SPEI_RESERVED1',
    'SPDATAKEYLOCATION', 'SRSEDone', 'SPEI_END_SR_STREAM',
    'SPAO_RETAIN_AUDIO', 'SGRSTTDictation', 'DISPID_SPELexicalForm',
    'DISPID_SWFESamplesPerSec', 'DISPID_SABIEventBias',
    'SAFT8kHz16BitStereo', 'SRTEmulated',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPRULE', 'ISpVoice',
    'DISPIDSPTSI_SelectionLength', 'SAFT32kHz16BitMono',
    'SPEI_RECO_OTHER_CONTEXT', 'SPSNoun', 'SP_VISEME_17',
    'SpeechAllElements', 'DISPID_SRCVoice', 'SPEI_TTS_AUDIO_LEVEL',
    'SpeechStreamFileMode', 'eLEXTYPE_PRIVATE3',
    'DISPID_SpeechPhraseAlternates', 'eLEXTYPE_PRIVATE12',
    'SpeechRecognizerState', 'tagSPPROPERTYINFO',
    'eLEXTYPE_RESERVED8', 'SVEEndInputStream',
    'DISPID_SpeechPhraseProperties',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SGRAddResource',
    'SPSERIALIZEDPHRASE', 'eLEXTYPE_MORPHOLOGY', 'SVP_16',
    'DISPID_SBSWrite', 'SP_VISEME_8', 'ISpXMLRecoResult',
    'DISPID_SOTDisplayUI', 'ISpeechVoiceStatus',
    'SAFTCCITT_uLaw_11kHzMono', 'SPINTERFERENCE_NOISE',
    'DISPID_SAStatus', 'SPRECORESULTTIMES',
    'ISpeechPhraseReplacement', 'DISPID_SPRs_NewEnum', 'SRATopLevel',
    'DISPID_SpeechAudioStatus', 'SPEI_RESERVED6',
    'SGDSActiveUserDelimited', 'DISPID_SFSOpen',
    'DISPID_SRGCmdSetRuleIdState', 'SPSLMA', 'eLEXTYPE_USER',
    'SREPhraseStart', 'SpeechEngineProperties', 'SP_VISEME_10',
    'SAFTCCITT_uLaw_22kHzMono', 'SSFMOpenForRead',
    'DISPID_SpeechFileStream', 'ISpeechAudioStatus',
    'DISPID_SLWsCount', 'STCRemoteServer',
    'DISPID_SOTGetStorageFileName', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPWT_LEXICAL', 'DISPID_SPRuleId', 'DISPID_SpeechPhraseInfo',
    'DISPID_SVEWord', 'DISPID_SPILanguageId',
    'DISPID_SRCEventInterests', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SVVoice', 'SpeechWordType',
    'DISPID_SLRemovePronunciation', 'DISPID_SRSCurrentStreamNumber',
    'SpeechCategoryPhoneConverters', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SPIEngineId', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFTGSM610_44kHzMono', 'SAFTNonStandardFormat',
    'eLEXTYPE_PRIVATE5', 'SVF_None', 'SVP_13', 'SREPropertyNumChange',
    'SVSFParseSapi', 'SpeechSpecialTransitionType',
    'ISpPhoneConverter', 'DISPID_SpeechGrammarRules',
    'DISPID_SPRuleNumberOfElements', 'ISpObjectToken',
    'SpeechCategoryAudioIn', 'SAFTNoAssignedFormat', 'SVP_11',
    'SPEI_VISEME', 'SPEI_MAX_TTS', 'DISPID_SPPChildren',
    'SAFT22kHz16BitStereo', 'DISPID_SPRulesCount',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SVSCurrentStreamNumber',
    'STCInprocServer', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRGIsPronounceable', 'SGSExclusive',
    'DISPID_SGRAttributes', 'SDA_Consume_Leading_Spaces',
    'SAFTADPCM_22kHzMono', 'SpInProcRecoContext', 'SGSEnabled',
    '_ISpeechRecoContextEvents', 'ISpeechPhraseInfoBuilder',
    'DISPID_SAFType', 'SPSMF_UPS', 'ISpProperties',
    'SAFTCCITT_ALaw_8kHzStereo', 'SpeechGrammarWordType',
    'SP_VISEME_5', 'SPEI_MIN_SR', 'SVEAllEvents',
    'DISPID_SpeechGrammarRuleState', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SpeechRecognizer', 'DISPID_SOTCreateInstance',
    'SPBO_AHEAD', 'SP_VISEME_7', 'SRAORetainAudio',
    'DISPID_SDKGetBinaryValue', 'DISPID_SPPNumberOfElements',
    'SPDKL_LocalMachine', 'SpeechCategoryVoices',
    'IEnumSpObjectTokens', 'DISPID_SPIAudioSizeBytes', 'SPXRO_SML',
    'DISPID_SRCEEnginePrivate', 'DISPID_SVEAudioLevel',
    'SDTLexicalForm', 'SAFT48kHz16BitMono', 'SpeechRecognitionType',
    'SPAR_Low', 'SSTTWildcard', 'ISpeechTextSelectionInformation',
    'STSF_LocalAppData', 'SPSMF_SRGS_SAPIPROPERTIES', 'ISpEventSink',
    'ISpeechObjectToken', 'SPEI_UNDEFINED', 'SVSFParseAutodetect',
    'DISPID_SpeechPhoneConverter', 'SGRSTTWildcard',
    'DISPID_SWFEAvgBytesPerSec', 'ISpNotifySource',
    'SPWORDPRONOUNCEABLE', 'SAFTADPCM_11kHzMono',
    'DISPID_SPRulesItem', 'SVP_2', 'SpeechAudioFormatGUIDWave',
    'DISPID_SVSRunningState', 'SPRST_INACTIVE_WITH_PURGE',
    'SPFM_NUM_MODES', 'SpFileStream', 'DISPID_SLPSymbolic',
    'SpResourceManager', 'SPEI_MIN_TTS', 'SPAR_High',
    'SVSFIsFilename', 'SVP_4', 'DISPID_SRSAudioStatus',
    'SREStreamEnd', 'DISPID_SDKEnumKeys', 'SAFT16kHz16BitStereo',
    'eWORDTYPE_DELETED', 'SAFTCCITT_ALaw_11kHzStereo', 'SPWF_INPUT',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRRTimes',
    'DISPID_SASFreeBufferSpace', 'SPSERIALIZEDRESULT',
    'DISPID_SPIAudioSizeTime', 'SpeechAudioState', 'ISpDataKey',
    'SDKLLocalMachine', 'SGLexicalNoSpecialChars', 'SPRST_NUM_STATES',
    'SPSInterjection', 'SRAONone', 'SVF_Emphasis',
    'DISPID_SREmulateRecognition', 'SPEVENT', 'SpWaveFormatEx',
    'eLEXTYPE_RESERVED9', 'DISPID_SWFEFormatTag', 'SPBO_PAUSE',
    'SECFNoSpecialChars', 'SAFT8kHz8BitStereo', 'DISPID_SGRAddState',
    'DISPID_SVStatus', 'SDKLCurrentUser', 'SPRS_INACTIVE',
    'DISPID_SRCRequestedUIType', 'DISPID_SBSRead',
    'DISPID_SRGCmdLoadFromObject', 'ISpStreamFormatConverter',
    'SRTExtendableParse', 'SREPropertyStringChange',
    'ISpeechPhraseElement', 'SAFTADPCM_11kHzStereo',
    'SPSHORTCUTPAIRLIST', 'DISPID_SRRSetTextFeedback',
    'SpeechAddRemoveWord', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRAudioInputStream', 'SPAS_STOP', 'SAFT16kHz8BitMono',
    'DISPID_SRRTLength', 'DISPID_SRCERecognition',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SpeechRecoResult',
    'SPPARTOFSPEECH', 'SPCT_SUB_DICTATION', 'DISPID_SRCEEndStream',
    'DISPID_SLPs_NewEnum', 'ISpeechPhraseProperty',
    'DISPID_SLGetPronunciations', 'SPCT_DICTATION',
    'DISPID_SRCERecognitionForOtherContext', 'SPCT_SUB_COMMAND',
    'DISPID_SGRs_NewEnum', 'DISPID_SPPParent',
    'DISPID_SRSClsidEngine', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SpeechBaseStream', 'SpMMAudioEnum',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SVEStreamStart',
    'SPGS_DISABLED', 'DISPID_SPPName', 'ISpRecoGrammar2',
    'SP_VISEME_20', 'DISPID_SVEStreamEnd', 'SPEI_REQUEST_UI',
    'SpCustomStream', 'SVEPrivate', 'SLTUser',
    'DISPID_SPPFirstElement', 'SRERecognition', 'ISpeechDataKey',
    'DISPID_SVSLastBookmark', 'DISPID_SPPConfidence', 'tagSTATSTG',
    'SPSSuppressWord', 'DISPID_SpeechLexicon', 'SRESoundStart',
    'eLEXTYPE_USER_SHORTCUT', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SBSSeek', 'DISPID_SRProfile', 'ISpGrammarBuilder',
    'DISPIDSPTSI_ActiveOffset', 'SPEI_RECO_STATE_CHANGE',
    'SpeechVisemeFeature', 'SpeechBookmarkOptions',
    'SPPS_SuppressWord', 'DISPID_SRCEHypothesis',
    'DISPID_SRGDictationSetState', 'STCLocalServer', 'SPPHRASERULE',
    'SAFT12kHz8BitMono', 'DISPID_SPIProperties', 'DISPID_SGRsCommit',
    'IInternetSecurityMgrSite', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPEPronunciation', 'DISPID_SDKSetLongValue',
    'DISPID_SVEViseme', 'SRADefaultToActive', 'SPPS_Noun',
    'SPINTERFERENCE_NONE', 'SpeechUserTraining', 'SREInterference',
    'SVPNormal', 'DISPID_SGRsCount', 'DISPID_SMSALineId',
    'DISPID_SLPsItem', 'DISPID_SPCLangId',
    'SpeechGrammarTagDictation', 'SAFTCCITT_uLaw_8kHzMono',
    'ISpRecoContext2', 'DISPID_SLAddPronunciation',
    'SVESentenceBoundary', 'DISPID_SADefaultFormat',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SLWsItem',
    'DISPID_SLPLangId', 'DISPID_SOTSetId',
    'ISpeechGrammarRuleStateTransition', 'SAFT44kHz16BitStereo',
    'SPPHRASEELEMENT', 'SAFTText', 'DISPID_SVSkip',
    'DISPID_SGRSTPropertyId', 'SRCS_Enabled', 'SVSFParseMask',
    'SpeechStreamSeekPositionType', 'SVSFIsXML',
    'SAFT24kHz16BitStereo', 'ISpMMSysAudio', 'ISpeechRecognizer',
    'DISPID_SOTCDefault', 'SpInprocRecognizer', 'SPSHORTCUTTYPE',
    'SpStream', 'DISPID_SPIEnginePrivateData', 'SpVoice',
    'DISPID_SMSGetData', 'eLEXTYPE_PRIVATE10', 'SVP_6',
    'DISPID_SOTId', 'DISPID_SRRDiscardResultInfo',
    'ISpSerializeState', 'eLEXTYPE_PRIVATE7', 'SGRSTTWord',
    'SPEI_SR_PRIVATE', 'DISPID_SVSVisemeId', 'SPRECOCONTEXTSTATUS',
    'DISPID_SpeechAudioFormat', 'SpMMAudioOut', 'SVEViseme',
    'SpeechGrammarRuleStateTransitionType', 'SPDKL_DefaultLocation',
    'SVEPhoneme', 'DISPID_SGRId', 'SRSActive', 'SAFT32kHz8BitStereo',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SVPriority', 'SAFT8kHz8BitMono',
    'DISPID_SOTCategory', 'eLEXTYPE_APP', 'DISPID_SPAs_NewEnum',
    'SpeechLoadOption', 'DISPID_SRGRecoContext',
    'SpeechPropertyResourceUsage', 'ISpeechPhraseAlternates',
    'SPEI_FALSE_RECOGNITION', 'UINT_PTR', 'DISPID_SVGetAudioOutputs',
    'SVP_19', 'SPPS_Modifier', 'SpeechPropertyAdaptationOn',
    'DISPID_SLWWord', 'SPRECOSTATE', 'SINone', 'SPWORDLIST',
    'SPDKL_CurrentConfig', 'SpeechRecoProfileProperties',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpeechAudioBufferInfo',
    'SGDisplay', 'DISPID_SpeechPhraseRule',
    'DISPID_SVSInputSentenceLength', 'DISPID_SAFSetWaveFormatEx',
    'SPPROPERTYINFO', 'DISPID_SDKGetStringValue', '_SPAUDIOSTATE',
    'SAFTGSM610_22kHzMono', 'SRAExport', 'ISpRecoGrammar',
    'eLEXTYPE_PRIVATE1', 'SASPause', 'SVP_20',
    'SpeechCategoryAppLexicons', 'DISPID_SPEDisplayText',
    'DISPID_SPCIdToPhone', 'SpeechRuleAttributes',
    'SPTEXTSELECTIONINFO', 'SVEAudioLevel',
    'SSSPTRelativeToCurrentPosition', 'ISpeechBaseStream',
    'SGDSInactive', 'DISPID_SVSpeak', 'DISPID_SRSetPropertyNumber',
    'DISPID_SVGetAudioInputs', 'SpeechRecoContextState',
    'eLEXTYPE_PRIVATE6', 'SP_VISEME_13', 'SPEI_PHRASE_START',
    'SPSEMANTICFORMAT', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SOTCGetDataKey', 'SPADAPTATIONRELEVANCE', 'SpObjectToken',
    'DISPID_SRGState', 'DISPID_SGRSTs_NewEnum', 'SPBO_TIME_UNITS',
    'DISPID_SDKOpenKey', 'SpeechAudioVolume', 'DISPID_SLWs_NewEnum',
    'DISPID_SWFEBlockAlign', 'DISPID_SPIGrammarId',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVSFPurgeBeforeSpeak',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SVEEnginePrivate',
    'SpeechPropertyHighConfidenceThreshold', '_RemotableHandle',
    'ISpObjectWithToken', 'SAFTExtendedAudioFormat',
    'DISPID_SOTIsUISupported', 'DISPIDSPRG', 'eLEXTYPE_PRIVATE16',
    'SpLexicon', 'ISpeechGrammarRules', 'SREStreamStart',
    'SPVPRI_NORMAL', 'DISPID_SPPId', 'DISPID_SPIGetText',
    'SP_VISEME_21', 'SVEStartInputStream', 'SRCS_Disabled',
    'DISPID_SVSLastStreamNumberQueued', 'SREAdaptation',
    'DISPID_SRGRules', 'SPEVENTSOURCEINFO', 'DISPID_SRCState',
    'ISpStream', 'eLEXTYPE_RESERVED7', 'DISPID_SPIStartTime',
    'DISPID_SPRules_NewEnum', 'DISPID_SRCEPropertyNumberChange',
    'SPSHT_EMAIL', 'ISpRecoResult', 'DISPID_SpeechPhraseProperty',
    'STSF_FlagCreate', 'DISPID_SpeechLexiconProns',
    'DISPID_SpeechMMSysAudio', 'DISPID_SRCESoundEnd', 'SVPOver',
    'DISPID_SOTCSetId', 'SPFM_OPEN_READWRITE', 'ISpStreamFormat',
    'ISpeechRecoResult', 'DISPID_SLGetWords',
    'DISPID_SRCCreateResultFromMemory',
    'DISPID_SLGetGenerationChange', 'DISPID_SRSNumberOfActiveRules',
    'SASStop', 'DISPID_SRGCmdLoadFromMemory', 'DISPID_SGRSTWeight',
    'SpPhoneticAlphabetConverter', 'SP_VISEME_19',
    'DISPID_SABIMinNotification', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'eLEXTYPE_PRIVATE4', 'DISPID_SGRsDynamic',
    'ISpeechPhraseElements', 'SPAR_Unknown', 'SAFT24kHz8BitStereo',
    'SPEI_END_INPUT_STREAM', 'SRTStandard', 'SPSEMANTICERRORINFO',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SABIBufferSize',
    'ISpRecoContext', 'DISPID_SVEventInterests',
    'SPEI_SR_AUDIO_LEVEL', 'SpSharedRecoContext', 'SVP_9', 'SVP_0',
    'SpeechTokenValueCLSID', 'SVP_1', 'DISPID_SpeechLexiconWords',
    'SpCompressedLexicon', 'DISPID_SGRSTRule', 'DISPID_SPIElements',
    'DISPID_SVPause', 'DISPID_SLPType', 'SPPS_Interjection',
    'DISPID_SRRPhraseInfo', 'DISPID_SpeechVoiceEvent',
    'SAFTGSM610_8kHzMono', 'SAFTGSM610_11kHzMono',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SpeechAudioBufferInfo',
    'ISpRecognizer', 'DISPID_SPCPhoneToId', 'SAFTADPCM_8kHzMono',
    'SPFILEMODE', 'DISPID_SRCRecognizer', 'DISPID_SVResume',
    'SPFM_CREATE', 'SRERecoOtherContext', 'SVPAlert',
    'DISPID_SRGReset', 'DISPID_SRCESoundStart', 'DISPID_SRIsShared',
    'SP_VISEME_4', 'SFTSREngine', 'DISPID_SRCRetainedAudio',
    'DISPID_SRCEFalseRecognition', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SVGetVoices', 'SAFT11kHz16BitMono',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpNotifyTranslator',
    'DISPID_SRState', 'ISpeechGrammarRuleState', 'SPPS_Noncontent',
    'SREHypothesis', 'SBONone', 'ISpeechAudio', 'SREStateChange',
    'DISPID_SpeechMemoryStream', 'SRSEIsSpeaking', 'DISPID_SRGId',
    'DISPID_SpeechObjectToken', 'SPPHRASEREPLACEMENT',
    'ISpeechRecoResultTimes', 'SREBookmark', 'DISPID_SPEs_NewEnum',
    'SpeechEmulationCompareFlags', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SpeechPhraseRules', 'SPWORDPRONUNCIATIONLIST',
    'ISpeechXMLRecoResult', 'SP_VISEME_18',
    'DISPID_SVESentenceBoundary', 'SPSNotOverriden', 'SPPS_RESERVED1',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SpeechLexiconWord',
    'DISPID_SPRsItem', 'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechTokenShellFolder', 'SPWAVEFORMATTYPE',
    'DISPID_SPIReplacements', 'SPRS_ACTIVE_USER_DELIMITED',
    'eLEXTYPE_PRIVATE15', 'SVP_12', 'SDKLCurrentConfig',
    'SPSHT_NotOverriden', 'SPWORDPRONUNCIATION', 'ISpeechRecoResult2',
    'DISPID_SpeechPhraseReplacements', 'SAFT16kHz8BitStereo',
    'ISpNotifySink', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRRAudioFormat', 'ISpPhoneticAlphabetConverter',
    'DISPID_SPPValue', 'SECFDefault', 'SAFTCCITT_ALaw_22kHzMono',
    'SPEI_PHONEME', 'DISPID_SPRDisplayAttributes',
    'SPXMLRESULTOPTIONS', 'ISpeechRecoGrammar', 'SPSFunction',
    'SpeechMicTraining', 'DISPID_SPISaveToMemory',
    'DISPID_SPRFirstElement', 'SVSFUnusedFlags', 'SSTTDictation',
    'DISPID_SVEVoiceChange', 'DISPID_SVEPhoneme',
    'eLEXTYPE_RESERVED10', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPGRAMMARWORDTYPE', 'ISpeechRecognizerStatus',
    'ISpeechFileStream', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPWT_DISPLAY', 'SITooSlow', 'SpeechEngineConfidence',
    'SGRSTTRule', 'SSFMCreate', 'SpeechTokenContext',
    'DISPID_SCSBaseStream', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SPAsItem', 'SAFTTrueSpeech_8kHz1BitMono',
    'ISpeechMemoryStream', 'DISPID_SRGDictationLoad',
    'DISPID_SVIsUISupported', 'ISpeechObjectTokenCategory',
    'ISpeechLexiconPronunciation', 'SpTextSelectionInformation',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SDKCreateKey',
    'SpeechGrammarTagUnlimitedDictation', 'SVEWordBoundary',
    'DISPID_SOTGetDescription', 'DISPID_SLPPhoneIds',
    'DISPID_SRRSaveToMemory', 'SAFT11kHz8BitMono',
    'Speech_StreamPos_RealTime', 'Speech_StreamPos_Asap',
    'DISPID_SRGCommit', 'eWORDTYPE_ADDED', 'DISPID_SRDisplayUI',
    'ISpeechVoice', 'SVF_Stressed', 'SVP_21', 'SPXRO_Alternates_SML',
    'DISPID_SPRuleEngineConfidence', 'SSSPTRelativeToEnd',
    'SPEI_INTERFERENCE', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechVoice', 'SPLOADOPTIONS', 'ISpeechPhraseInfo',
    'SRAInterpreter', 'DISPID_SLWLangId', 'ISpShortcut',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SOTDataKey',
    'SVEVoiceChange', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SPIRule', 'eLEXTYPE_RESERVED6',
    'DISPID_SRGDictationUnload', 'SPCONTEXTSTATE',
    'SpeechGrammarTagWildcard', 'SLTApp', 'IInternetSecurityManager',
    'DISPID_SPRText', 'SPBINARYGRAMMAR', 'SpPhoneConverter',
    'SP_VISEME_11', 'eLEXTYPE_PRIVATE2', 'DISPID_SVAlertBoundary',
    'ISpLexicon', 'SLOStatic', 'SAFT44kHz8BitStereo',
    'DISPID_SLWPronunciations', 'SRSInactive',
    'DISPID_SPERequiredConfidence', 'DISPID_SPRuleFirstElement',
    'DISPID_SVSPhonemeId', 'DISPID_SOTCId', 'SPLO_DYNAMIC',
    'SREAllEvents', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SpeechPhraseElement', 'DISPID_SRCCreateGrammar',
    'WAVEFORMATEX', 'SPPS_RESERVED3', 'SPGS_ENABLED',
    'DISPID_SABufferInfo', 'DISPID_SRCResume', 'SINoise',
    'DISPID_SGRSAddWordTransition', 'SVP_8', 'SPEI_RESERVED5',
    'SPAO_NONE', 'SVP_17', 'DISPID_SGRInitialState',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SVWaitUntilDone',
    'SAFT12kHz8BitStereo', 'SpeechPropertyComplexResponseSpeed',
    'SpeechFormatType', 'DISPID_SOTRemove', 'SPCATEGORYTYPE',
    'DISPID_SpeechWaveFormatEx', 'SVSFPersistXML', 'DISPID_SPPsCount',
    'SWPKnownWordPronounceable', 'DISPID_SGRsFindRule',
    'ISpeechWaveFormatEx', 'SPCS_DISABLED', 'SAFTDefault',
    'SDA_No_Trailing_Space', 'SRADynamic', '_ISpeechVoiceEvents',
    'SPAS_CLOSED', 'SPPS_RESERVED2', 'SAFT22kHz8BitStereo',
    'ISpeechObjectTokens', 'SPFM_CREATE_ALWAYS',
    'DISPID_SRGSetTextSelection', 'DISPID_SRSSupportedLanguages',
    'DISPIDSPTSI', 'SPPHRASEPROPERTY', 'SAFT12kHz16BitStereo',
    'SpeechRecoEvents', 'SPEI_VOICE_CHANGE', 'SPSHORTCUTPAIR',
    'STCInprocHandler', 'DISPID_SWFEExtraData', 'eLEXTYPE_PRIVATE18',
    'SECHighConfidence', 'IEnumString', 'DISPID_SRCEPhraseStart',
    'ISpRecognizer2', 'SPSHT_OTHER', 'SPAUDIOSTATE',
    'DISPID_SPACommit', 'SECLowConfidence', 'SASRun', 'SPPS_Function',
    'SREPrivate', 'SAFTCCITT_ALaw_11kHzMono', 'ISpeechPhraseRule',
    'SASClosed', 'DISPID_SDKDeleteKey', 'SPRST_ACTIVE', 'SITooQuiet',
    'SITooFast', 'DISPID_SOTGetAttribute', 'SP_VISEME_16',
    'SPAS_PAUSE', 'DISPID_SOTsCount', 'ISpeechPhraseAlternate',
    'DISPID_SOTs_NewEnum', 'SPSTREAMFORMATTYPE',
    'ISpeechLexiconWords', 'eLEXTYPE_PRIVATE14', 'SVSFParseSsml',
    'SPPS_Verb', 'SPVOICESTATUS', 'SP_VISEME_2', 'SVEBookmark',
    'SRTSMLTimeout', 'SP_VISEME_14', 'DISPID_SGRName', 'SBOPause',
    'SpeechGrammarState', 'DISPID_SpeechRecoContext',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SpeechRecoContextEvents',
    'SPPHRASE', 'DISPID_SGRSTsCount', 'DISPID_SpeechDataKey',
    'SGLexical', 'DISPID_SRCEAudioLevel', 'SPAUDIOBUFFERINFO',
    'tagSPTEXTSELECTIONINFO', 'SINoSignal', 'DISPID_SGRClear',
    'SRESoundEnd', 'SPLO_STATIC', 'SAFT32kHz16BitStereo',
    'SAFTADPCM_8kHzStereo', 'DISPID_SpeechCustomStream',
    'DISPID_SGRsAdd', 'ISpeechLexiconPronunciations',
    'DISPID_SVAudioOutput', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRCreateRecoContext', 'ISpAudio', 'LONG_PTR',
    'SPEI_RESERVED3', 'SDTAll', 'STSF_AppData', 'SPSVerb',
    'DISPID_SABufferNotifySize', 'DISPID_SRRAudio', 'SPVPRI_ALERT',
    'SPRECOGNIZERSTATUS', 'DISPID_SPEEngineConfidence',
    'SRSActiveAlways', 'SPPS_Unknown', 'SPEVENTENUM',
    'SpeechInterference', 'SPPS_LMA', 'SpeechLexiconType',
    'SPEI_PROPERTY_NUM_CHANGE', 'SECFEmulateResult',
    'eLEXTYPE_PRIVATE9', 'SpeechWordPronounceable',
    'DISPID_SPIGetDisplayAttributes', 'SpNotifyTranslator',
